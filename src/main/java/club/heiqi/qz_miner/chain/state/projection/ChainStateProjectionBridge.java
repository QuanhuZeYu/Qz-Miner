 ...
 * <h3>守框架约束</h3>
 * <ul>
 *   <li><b>边界不越权</b>：本桥只 {@code sendTo} 下发快照，<b>绝不</b>调 {@code applyTransition}/
 *       {@code transition}。状态机仍是 phase/generation 唯一写权威。</li>
 *   <li><b>跨线程只经事件总线</b>：本桥仅在主线程 drain 调用（ChainPhaseChanged 由主线程 drain publish 触发订阅者），
 *       {@code sendTo} 是网络层入队操作，本身线程安全。</li>
 *   <li><b>唯一写权威</b>：本桥是只读订阅者，不改状态机态。</li>
 * </ul>
 *
 * <h3>阶段8 块3 现状</h3>
