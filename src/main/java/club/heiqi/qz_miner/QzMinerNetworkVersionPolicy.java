...
final class QzMinerNetworkVersionPolicy {
     ...
     * 判断 Forge 版本表是否可接受。
     *
     * <p>远端未声明本模组时只放行 mod-list 检查；一旦声明，双方版本都必须是完整、合法的 5.3
    ...
    /**
     * 解析完整 ASCII SemVer 形态并判断 core 是否属于 5.3。
     *
     * @param version 待检查版本
     * @return 版本语法合法且 major/minor 为 5.3
     */
