...
import club.heiqi.qz_miner.minerModes.chainMode.posFounder.ChainGroupFounder;
import net.minecraft.block.Block;
import net.minecraft.util.ChatComponentText;
import org.joml.Vector3i;

public class ChainGroupMode extends AbstractMode {
    public final BlockBreaker breaker;

    public ChainGroupMode(ModeManager modeManager, Vector3i center) {
        super(modeManager, center);
        breaker = new BlockBreaker(modeManager.player, modeManager.world);
        timer = System.currentTimeMillis();
        positionFounder = new ChainGroupFounder(this, center, modeManager.player);
    }
