...
public class TunnelFounderThread extends PositionFounderThread {


    public TunnelFounderThread(AbstractMode mode) {
        super(mode);
    ...
    public Vector3f getDirection() {
        double yawRadians = Math.toRadians(manager.player.rotationYaw);
        double pitchRadians = Math.toRadians(manager.player.rotationPitch);
