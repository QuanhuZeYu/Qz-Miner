...
import club.heiqi.qz_miner.minerMode.chainMode.posFounder.ChainFounder_Lumberjack;
...
public class LumberJackMode extends AbstractMode {
    ...
    public LumberJackMode(ModeManager modeManager, Vector3i center, Sides sides) {
        super(modeManager, center, sides);
        EntityPlayer player = modeManager.player;
        timer = System.currentTimeMillis();
        positionFounder = new ChainFounder_Lumberjack(this);
