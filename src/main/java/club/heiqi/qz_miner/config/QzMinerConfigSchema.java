        ...
        return ConfigSchema.builder("qz_miner")
                ...
                .section("client")
                    ...
                    .bool("autoToolSwapEnabled")
                        ...
                        .build()
                    .bool("autoToolTakeoverEnabled")
                        .defaultValue(Boolean.valueOf(QzMinerConfigDefaults.CLIENT_AUTO_TOOL_TAKEOVER_ENABLED))
                        .label("autoToolTakeoverEnabled")
                        .helper("是否在连锁中工具耗尽时自动接替；关闭后新请求会 DECLINE，不影响已有事务收口")
                        .build()
