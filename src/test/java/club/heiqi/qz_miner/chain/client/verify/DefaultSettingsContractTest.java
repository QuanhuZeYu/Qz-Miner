...
public class DefaultSettingsContractTest {
    ...
    public void frozenDefaultsMatchInterfaceFreezeAndDoNotExceedImplementation() {
        ...
        Assert.assertEquals(0xE8503C, QzMinerConfigDefaults.CLIENT_PREVIEW_COLOR_AREA);
        Assert.assertEquals(0x58E07A, QzMinerConfigDefaults.CLIENT_PREVIEW_COLOR_INTERACT);
        ...
        Assert.assertEquals(0xF8C858, QzMinerConfigDefaults.CLIENT_PREVIEW_COLOR_TRUNCATED);
    ...
    public void configSnapshotMapsEveryFrozenDefault() {
        ...
        try {
            ...
            Assert.assertEquals(0xE8503C, settings.getColorArea());
            Assert.assertEquals(0x58E07A, settings.getColorInteract());
            Assert.assertEquals(0xB08CFF, settings.getColorSecondary());
            Assert.assertEquals(0x8FA9D0, settings.getColorRemote());
            Assert.assertEquals(0xF8C858, settings.getColorTruncated());
