...
public class AutoToolSwapNetworkRegistrationStructureTest {
    ...
    public void toolSwapPacketsAppendAfterExistingPacketsInProtocolOrder() throws Exception {
        ...
        int cuboidRequest = source.indexOf("PacketCuboidSelectionRequest.Handler.class");
        int cuboidSync = source.indexOf("PacketCuboidSelectionSync.Handler.class");
        ...
        Assert.assertTrue(roundPhase < cuboidRequest);
        Assert.assertTrue(cuboidRequest < cuboidSync);
        ...
        assertSide(source, cuboidRequest, "Side.SERVER");
        assertSide(source, cuboidSync, "Side.CLIENT");
    }
