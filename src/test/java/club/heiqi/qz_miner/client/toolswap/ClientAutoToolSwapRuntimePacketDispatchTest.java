...
public class ClientAutoToolSwapRuntimePacketDispatchTest {
    ...
    @Test
    public void proxyCapturesConnectionAndPublishesAllThreePacketsThroughWorldGate() throws Exception {
        ...
        Assert.assertEquals(3, occurrences(source, "ClientAutoToolSwapPacketDispatch.dispatch(token"));
