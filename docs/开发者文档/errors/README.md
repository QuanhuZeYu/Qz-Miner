...
- [`ERROR-20260609-qz-uilib-dev-runtime-deobf.md`](ERROR-20260609-qz-uilib-dev-runtime-deobf.md) - Qz-UILib 发布 jar 直接进入 RFG dev runtime 时保留 SRG 方法名，导致 Java 21 客户端启动时 `ClientCommandHandler.func_71560_a(...)` 找不到。
